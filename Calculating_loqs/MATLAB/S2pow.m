...
if is_int == 0
    ...
    % Find us the "ans" that gave us ln_of_ans
        ...
        iterations = (guess_low+guess_high)/2;
        i=0;
        while 1
            ...
            if abs(guess_mid - guess_high) <= 1e-20
                break
            end
    ...
    % Below is to see values
    %S2answer = iterations;
    %S2answer = iterations*S2intpow(x, pow_int);
    S2answer = guess_mid*S2intpow(x, pow_int);

    end
end


    function [ answer ] = S2log2_e( n )
